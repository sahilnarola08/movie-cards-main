...
const Favorites = () => {
    ...
    const fetchMovies = async () => {
      try {
        ...
        const favoriteMovies = response?.movies?.filter((movie) => movie.isFavorite);
      ...
      return(
        ...
        <div className='mt-5 cursor-pointer' onClick={()=>{handleFavorite(item._id)}}>
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 40 40">
            <path fill={item.isFavorite ? "#F4FF50" : "#dff0fe"}  d="M20 31.441L8.5 37.191 8.5 2.5 31.5 2.5 31.5 37.191z"></path>
            <path fill={item.isFavorite ? "#515300" : "#4788c7"} d="M31,3v33.382l-10.553-5.276L20,30.882l-0.447,0.224L9,36.382V3H31 M32,2H8v36l12-6l12,6V2L32,2z"></path>
          </svg>
        </div>
        </div>
        <div className="my-4">
